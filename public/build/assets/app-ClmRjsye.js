    ...
    o((e, t) => {
      (function (n, r) {
        ...
        S.prototype = {
          ...
          add: function (e) {
            return this.clone()._add(C(e));
          },
          _add: function (e) {
            return ((this.x += e.x), (this.y += e.y), this);
          },
          subtract: function (e) {
            return this.clone()._subtract(C(e));
          },
          ...
          equals: function (e) {
            return ((e = C(e)), e.x === this.x && e.y === this.y);
          },
          contains: function (e) {
            return (
              (e = C(e)),
        ...
        w.prototype = {
          extend: function (e) {
            var t, n;
            if (!e) return this;
            if (e instanceof S || typeof e[0] == `number` || `x` in e)
              t = n = C(e);
            else if (((e = T(e)), (t = e.min), (n = e.max), !t || !n))
              return this;
            return (
              !this.min && !this.max
          ...
          contains: function (e) {
            var t, n;
            return (
              (e = typeof e[0] == `number` || e instanceof S ? C(e) : T(e)),
              e instanceof w ? ((t = e.min), (n = e.max)) : (t = n = e),
              t.x >= this.min.x &&
                n.x <= this.max.x &&
                t.y >= this.min.y &&
                n.y <= this.max.y
          ...
          pad: function (e) {
            ...
            return T(C(t.x - r, t.y - i), C(n.x + r, n.y + i));
          },
          equals: function (e) {
            return e
              ? ((e = T(e)),
        ...
        E.prototype = {
          extend: function (e) {
            var t = this._southWest,
              ...
              r,
              i;
            if (e instanceof O) ((r = e), (i = e));
            else if (e instanceof E) {
              if (((r = e._southWest), (i = e._northEast), !r || !i))
                return this;
            } else return e ? this.extend(k(e) || D(e)) : this;
            return (
              !t && !n
                ? ((this._southWest = new O(r.lat, r.lng)),
                  (this._northEast = new O(i.lat, i.lng)))
          ...
          pad: function (e) {
            ...
            return new E(
              new O(t.lat - r, t.lng - i),
              new O(n.lat + r, n.lng + i)
            );
          },
          getCenter: function () {
            return new O(
          ...
          contains: function (e) {
            e =
              typeof e[0] == `number` || e instanceof O || `lat` in e
                ? k(e)
                : D(e);
            var t = this._southWest,
              n = this._northEast,
        ...
        function D(e, t) {
          return e instanceof E ? e : new E(e, t);
        }
        function O(e, t, n) {
          if (isNaN(e) || isNaN(t))
            ...
            : _(e) && typeof e[0] != `object`
              ...
              : e == null
                ...
                : typeof e == `object` && `lat` in e
                  ? new O(e.lat, `lng` in e ? e.lng : e.lon, e.alt)
                  : t === void 0
                    ? null
                    : new O(e, t, n);
        }
        var A = {
            ...
            wrapLatLngBounds: function (e) {
              ...
              var a = e.getSouthWest(),
                o = e.getNorthEast();
              return new E(
                new O(a.lat - r, a.lng - i),
                new O(o.lat - r, o.lng - i)
              );
            },
          },
          de = n({}, A, {
        ...
        var Ct = Ft([
          ...
          Tt =
            wt === `webkitTransition` || wt === `OTransition`
              ? wt + `End`
              : `transitionend`;
        function Et(e) {
          ...
          W = le.extend({
            ...
            initialize: function (e, t) {
              ((t = p(this, t)),
                ...
                t.center &&
                  t.zoom !== void 0 &&
                  this.setView(k(t.center), t.zoom, { reset: !0 }),
                this.callInitHooks(),
                (this._zoomAnimated =
                  wt &&
                  M.any3d &&
                ...
                this._zoomAnimated &&
                  ...
                  B(this._proxy, Tt, this._catchTransitionEnd, this)),
                this._addLayers(this.options.layers));
            },
            setView: function (e, t, r) {
              return (
                (t = t === void 0 ? this._zoom : this._limitZoom(t)),
                (e = this._limitCenter(k(e), t, this.options.maxBounds)),
                (r ||= {}),
                this._stop(),
                this._loaded &&
                !r.reset &&
            ...
            zoomIn: function (e, t) {
              return (
                (e ||= M.any3d ? this.options.zoomDelta : 1),
            ...
            setZoomAround: function (e, t, n) {
              var r = this.getZoomScale(t),
                ...
                a = (e instanceof S ? e : this.latLngToContainerPoint(e))
                  .subtract(i)
                  .multiplyBy(1 - 1 / r),
            ...
            _getBoundsCenterZoom: function (e, t) {
              ((t ||= {}), (e = e.getBounds ? e.getBounds() : D(e)));
              var n = C(t.paddingTopLeft || t.padding || [0, 0]),
                r = C(t.paddingBottomRight || t.padding || [0, 0]),
            ...
            panInsideBounds: function (e, t) {
              ...
              var n = this.getCenter(),
                r = this._limitCenter(n, this._zoom, D(e));
              return (
            ...
            panInside: function (e, t) {
              ...
              var n = C(t.paddingTopLeft || t.padding || [0, 0]),
                ...
                s = T([o.min.add(n), o.max.subtract(r)]),
                c = s.getSize();
              if (!s.contains(a)) {
                this._enforcingBounds = !0;
            ...
            getBoundsZoom: function (e, t, n) {
              ...
              var r = this.getZoom() || 0,
                ...
                l = T(this.project(s, r), this.project(o, r)).getSize(),
            ...
            project: function (e, t) {
              return (
                (t = t === void 0 ? this._zoom : t),
                this.options.crs.latLngToPoint(k(e), t)
              );
            },
            unproject: function (e, t) {
              return (
                (t = t === void 0 ? this._zoom : t),
                this.options.crs.pointToLatLng(C(e), t)
              );
            },
            layerPointToLatLng: function (e) {
              var t = C(e).add(this.getPixelOrigin());
              return this.unproject(t);
            },
            latLngToLayerPoint: function (e) {
              return this.project(k(e))
                ._round()
            ...
            containerPointToLayerPoint: function (e) {
              return C(e).subtract(this._getMapPanePos());
            },
            layerPointToContainerPoint: function (e) {
              return C(e).add(this._getMapPanePos());
            },
            containerPointToLatLng: function (e) {
              var t = this.containerPointToLayerPoint(C(e));
              return this.layerPointToLatLng(t);
            },
            latLngToContainerPoint: function (e) {
              return this.layerPointToContainerPoint(
                this.latLngToLayerPoint(k(e))
              );
            },
            ...
            _initContainer: function (e) {
              ...
              (B(t, `scroll`, this._onScroll, this),
            ...
            _initPanes: function () {
              ...
              ((this._paneRenderers = {}),
                ...
                this.options.markerZoomAnimation ||
                  (F(e.markerPane, `leaflet-zoom-hide`),
                  F(e.shadowPane, `leaflet-zoom-hide`)));
            },
            ...
            _getMapPanePos: function () {
              return Lt(this._mapPane) || new S(0, 0);
            },
            _moved: function () {
              var e = this._getMapPanePos();
            ...
            _limitOffset: function (e, t) {
              ...
              var n = this.getPixelBounds(),
                r = new w(n.min.add(e), n.max.add(e));
            ...
            _getBoundsOffset: function (e, t, n) {
              ...
              return new S(this._rebound(i.x, -a.x), this._rebound(i.y, -a.y));
            },
        ...
        var hn = G.extend({
            ...
            _update: function () {
              ...
              (Ot(this._baseLayersList),
                Ot(this._overlaysList),
                (this._layerControlInputs = []));
              var e,
                t,
                n,
        ...
        var Sn = { Events: x },
          ...
          wn = le.extend({
            ...
            enable: function () {
              this._enabled ||=
                (B(this._dragStartTarget, Cn, this._onDown, this), !0);
            },
            disable: function () {
              this._enabled &&
            ...
            _onDown: function (e) {
              if (
                this._enabled &&
                ((this._moved = !1), !jt(this._element, `leaflet-zoom-anim`))
              ) {
                ...
                if (
                  ...
                  var t = e.touches ? e.touches[0] : e,
                    n = Jt(this._element);
                  ((this._startPoint = new S(t.clientX, t.clientY)),
            ...
            _onMove: function (e) {
              if (this._enabled) {
                ...
                var t = e.touches && e.touches.length === 1 ? e.touches[0] : e,
                  n = new S(t.clientX, t.clientY)._subtract(this._startPoint);
                (!n.x && !n.y) ||
            ...
            finishDrag: function (e) {
              (I(document.body, `leaflet-dragging`),
                (this._lastTarget &&=
                  (I(this._lastTarget, `leaflet-drag-target`), null)),
          ...
          for (s = 0; s < 4; s++) {
            for (
              ...
              ((c = e[a]),
                ...
                c._code & d
                  ? l._code & d ||
                    ((f = Ln(l, c, d, t, n)), (f._code = Rn(f, t)), r.push(f))
                  : (l._code & d &&
                      ((f = Ln(l, c, d, t, n)),
                      (f._code = Rn(f, t)),
                      r.push(f)),
        ...
        function En(e, t) {
          ...
          for (n = 0; n < p; n++) {
            var h = k(e[n]);
            m.push(t.project(k([h.lat - d.lat, h.lng - d.lng])));
          }
          for (s = c = l = 0, n = 0, r = p - 1; n < p; r = n++)
            ((i = m[n]),
              ...
              (s += o * 3));
          u = s === 0 ? m[0] : [c / s, l / s];
          var g = t.unproject(C(u));
          return k([g.lat + d.lat, g.lng + d.lng]);
        }
        function Dn(e) {
        ...
        function Hn(e, t) {
          ...
          for (n = 0; n < f; n++) {
            var m = k(e[n]);
            p.push(t.project(k([m.lat - u.lat, m.lng - u.lng])));
          }
          ...
          var h = t.unproject(C(l));
          return k([h.lat + u.lat, h.lng + u.lng]);
        }
        var Un = {
            __proto__: null,
            simplify: kn,
        ...
        var Xn = J.extend({
          ...
          $n = b.extend({
            ...
            _getIconUrl: function (e) {
              return (
                (M.retina && this.options[e + `RetinaUrl`]) ||
                this.options[e + `Url`]
              );
            },
          });
        ...
        var tr = $n.extend({
            ...
            _getIconUrl: function (e) {
              return (
                typeof tr.imagePath != `string` &&
                  (tr.imagePath = this._detectIconPath()),
                (this.options.imagePath || tr.imagePath) +
                  $n.prototype._getIconUrl.call(this, e)
              );
            },
          ...
          nr = K.extend({
            ...
            removeHooks: function () {
              (this._draggable
                ...
                .disable(),
                this._marker._icon &&
                  I(this._marker._icon, `leaflet-marker-draggable`));
            },
            moved: function () {
          ...
          rr = J.extend({
            ...
            _initIcon: function () {
              ...
              (n !== this._icon &&
                ...
                this.options.autoPanOnFocus &&
                  B(n, `focus`, this._panOnFocus, this));
            ...
            _removeIcon: function () {
              (this.options.riseOnHover &&
                ...
                this.options.autoPanOnFocus &&
                  H(this._icon, `focus`, this._panOnFocus, this),
                P(this._icon),
            ...
            _initInteraction: function () {
              if (
                ...
                (F(this._icon, `leaflet-interactive`),
            ...
            _updateOpacity: function () {
              ...
              (this._icon && R(this._icon, e),
                this._shadow && R(this._shadow, e));
            },
            ...
            _panOnFocus: function () {
              ...
              if (e) {
                var t = this.options.icon.options,
                  n = t.iconSize ? C(t.iconSize) : C(0, 0),
                  r = t.iconAnchor ? C(t.iconAnchor) : C(0, 0);
        ...
        var ar = J.extend({
          ...
          or = ar.extend({
            ...
            setStyle: function (e) {
              ...
              return (
                ar.prototype.setStyle.call(this, e),
                this.setRadius(t),
                this
              );
            },
        ...
        var cr = or.extend({
          ...
          _project: function () {
            var e = this._latlng.lng,
              ...
              n = this._map,
              r = n.options.crs;
            if (r.distance === de.distance) {
              var i = Math.PI / 180,
                a = this._mRadius / de.R / i,
                o = n.project([t + a, e]),
                s = n.project([t - a, e]),
        ...
        var X = ar.extend({
          ...
          _convertLatLngs: function (e) {
            for (var t = [], n = q(e), r = 0, i = e.length; r < i; r++)
              n
                ? ((t[r] = k(e[r])), this._bounds.extend(t[r]))
        ...
        var dr = X.extend({
          ...
          _convertLatLngs: function (e) {
            var t = X.prototype._convertLatLngs.call(this, e),
              n = t.length;
            return (
              n >= 2 && t[0] instanceof O && t[0].equals(t[n - 1]) && t.pop(),
              t
            );
          },
          _setLatLngs: function (e) {
          ...
          _clipPoints: function () {
            var e = this._renderer._bounds,
              ...
              n = new S(t, t);
            if (
              ((e = new w(e.min.subtract(n), e.max.add(n))),
              (this._parts = []),
              !(!this._pxBounds || !this._pxBounds.intersects(e)))
            ) {
              if (this.options.noClip) {
          ...
          switch (n.type) {
            ...
            case `MultiPoint`:
              for (l = 0, u = r.length; l < u; l++)
                ((s = o(r[l])), i.push(mr(a, e, s, t)));
              return new Y(i);
            case `LineString`:
            case `MultiLineString`:
              return (
                (c = gr(r, n.type === `LineString` ? 0 : 1, o)),
                new X(c, t)
              );
            case `Polygon`:
            case `MultiPolygon`:
              return (
                (c = gr(r, n.type === `Polygon` ? 1 : 2, o)),
                new dr(c, t)
              );
        ...
        var Cr = Sr,
          wr = J.extend({
            ...
            initialize: function (e, t, n) {
              ((this._url = e), (this._bounds = D(t)), p(this, n));
            },
            onAdd: function () {
              (this._image ||
                (this._initImage(),
                ...
                this.options.interactive &&
                  (F(this._image, `leaflet-interactive`),
        ...
        var Q = J.extend({
          ...
          initialize: function (e, t) {
            (e && (e instanceof O || _(e))
              ? ((this._latlng = k(e)), p(this, t))
          ...
          _updatePosition: function () {
            if (this._map) {
              var e = this._map.latLngToLayerPoint(this._latlng),
                t = C(this.options.offset),
                n = this._getAnchor();
              this._zoomAnimated
                ? z(this._container, e.add(n))
                : (t = t.add(e).add(n));
            ...
            onAdd: function (e) {
              (Q.prototype.onAdd.call(this, e),
                ...
                this._source &&
                  ...
                  this._source instanceof ar ||
                    this._source.on(`preclick`, tn)));
            },
            onRemove: function (e) {
            ...
            _adjustPan: function () {
              if (this.options.autoPan) {
                ...
                var a = e.layerPointToContainerPoint(i),
                  o = C(this.options.autoPanPadding),
                  s = C(this.options.autoPanPaddingTopLeft || o),
                  c = C(this.options.autoPanPaddingBottomRight || o),
                  l = e.getSize(),
                  u = 0,
                  d = 0;
        ...
        var Mr = Q.extend({
            ...
            setOpacity: function (e) {
              ((this.options.opacity = e),
                this._container && R(this._container, e));
            },
            _animateZoom: function (e) {
              var t = this._map._latLngToNewLayerPoint(
                this._latlng,
        ...
        var Ir = J.extend({
          ...
          bringToFront: function () {
            return (
              this._map && (kt(this._container), this._setAutoZIndex(Math.max)),
              this
            );
          },
          bringToBack: function () {
            return (
              this._map && (At(this._container), this._setAutoZIndex(Math.min)),
              this
            );
          },
          getContainer: function () {
          ...
          _getTiledPixelBounds: function (e) {
            ...
            return new w(i.subtract(a), i.add(a));
          },
          _update: function (e) {
            var t = this._map;
            if (t) {
              ...
              if (
                ...
                for (var l in this._tiles) {
                  ...
                  (u.z !== this._tileZoom || !c.contains(new S(u.x, u.y))) &&
          ...
          _isValidTile: function (e) {
            ...
            return D(this.options.bounds).overlaps(r);
          },
          ...
          _removeTile: function (e) {
            ...
            if (t)
              return (
                ...
                Ir.prototype._removeTile.call(this, e)
              );
          },
          _tileReady: function (e, t, n) {
        ...
        var Br = Rr.extend({
          ...
          onAdd: function (e) {
            ...
            ((this.wmsParams[t] = this._crs.code),
              Rr.prototype.onAdd.call(this, e));
          },
          getTileUrl: function (e) {
            var t = this._tileCoordsToNwSe(e),
              n = this._crs,
              r = T(n.project(t[0]), n.project(t[1])),
              i = r.min,
              a = r.max,
              o = (
        ...
        var $ = J.extend({
            ...
            onAdd: function () {
              (this._container ||
                (this._initContainer(),
                F(this._container, `leaflet-zoom-animated`)),
                this.getPane().appendChild(this._container),
                this._update(),
        ...
        var Wr = (function () {
          ...
          Gr = {
            ...
            _update: function () {
              this._map._animatingZoom ||
                ($.prototype._update.call(this), this.fire(`update`));
            },
            _initPath: function (e) {
        ...
        var Zr = K.extend({
          ...
          _finish: function () {
            (this._moved &&
              (P(this._box), I(this._container, `leaflet-crosshair`)),
              zt(),
              Ut(),
              H(
                document,
        ...
        (W.addInitHook(`addHandler`, `boxZoom`, Zr),
            ...
            if (!(e.altKey || e.ctrlKey || e.metaKey)) {
              ...
              if (t in this._panKeys) {
                if (!n._panAnim || !n._panAnim._inProgress)
                  if (
                    ((r = this._panKeys[t]),
                    e.shiftKey && (r = C(r).multiplyBy(3)),
                    n.options.maxBounds &&
                      (r = n._limitOffset(C(r), n.options.maxBounds)),
        ...
        var ri = K.extend({
          ...
          _onDown: function (e) {
            if ((clearTimeout(this._holdTimeout), e.touches.length === 1)) {
              var t = e.touches[0];
              ((this._startPos = this._newPos = new S(t.clientX, t.clientY)),
          ...
          _cancelClickPrevent: function e() {
            (H(document, `touchend`, U),
              H(document, `touchend touchcancel`, e));
          },
          _cancel: function () {
          ...
          _onMove: function (e) {
            var t = e.touches[0];
            this._newPos = new S(t.clientX, t.clientY);
          },
        ...
        var ii = K.extend({
          ...
          _onTouchMove: function (e) {
            if (!(!e.touches || e.touches.length !== 2 || !this._zooming)) {
              ...
              ((this._animRequest = v(s, this, !0)), U(e));
            }
          },
...
function _(e) {
  let t = [27, 64];
  for (let n of e.lines || []) t.push(...h(`${n}\n`));
  return (
    e.qr &&
      (t.push(
        ...h(`
...
((window.jawlaBluetoothPrinter = ({ payload: e }) => ({
  ...
  hasSavedPrinter: !!window.localStorage.getItem(u),
  ...
  async printDocument() {
    if (this.supported) {
      ...
      try {
        let e = await te();
        if (((e ||= (await this.pairPrinter(), await te())), !e))
          throw Error(
            document.documentElement.lang === `ar`
              ? `اختر طابعة أولاً.`
              : `Choose a printer first.`
          );
        let t = await ee(e.gatt?.connected ? e.gatt : await e.gatt.connect()),
          n = _(this.payload);
        for (let e of m(n))
