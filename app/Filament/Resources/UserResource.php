...
public static function getNavigationGroup(): ?string { return app()->getLocale() === 'ar' ? 'الشركة' : 'Company'; }
    public static function getLabel(): string { return app()->getLocale() === 'ar' ? 'مستخدم' : 'User'; }
    public static function getPluralLabel(): string { return app()->getLocale() === 'ar' ? 'المستخدمين' : 'Users'; }
