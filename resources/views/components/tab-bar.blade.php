...
<nav class="tab-bar" aria-label="Bottom navigation">
    <a href="/app" class="tab-item {{ $active === 'home' ? 'active' : '' }}">
    ...
    <a href="/app/customers" class="tab-item {{ $active === 'customers' ? 'active' : '' }}">
    ...
    <a href="/app/stock" class="tab-item {{ $active === 'stock' ? 'active' : '' }}">
    ...
    <a href="/app/more" class="tab-item {{ $active === 'more' ? 'active' : '' }}">
