    ...
    <div class="more-section">
        ...
        <a href="/app/transfers" class="more-item">
            <div class="more-item-icon more-icon-blue">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="20" height="20"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>
            </div>
            <div class="more-item-body">
